...
public class ArdlangParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("Ardlang");
  ...
  { 
    ArdlangParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = ArdlangParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = ArdlangParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(ArdlangParseControllerGenerated.class);
    }
  ...
  { 
    return ArdlangParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
